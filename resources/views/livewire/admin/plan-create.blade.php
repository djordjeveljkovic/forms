<div class="flex h-full w-full flex-1 flex-col gap-6">
    <div class="flex flex-col gap-1">
        ...
        <flux:heading size="xl" level="1">{{ __('Create plan') }}</flux:heading>
    </div>
    ...
    <flux:card>
        <form wire:submit="save" class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-3">
                ...
                <flux:text class="text-sm text-zinc-500">{{ __('Short feature flags shown on the plan.') }}</flux:text>
            ...
            <div class="grid gap-4 sm:grid-cols-3">
                ...
                <flux:field variant="inline">
                    ...
                    <flux:description>{{ __('New users will be assigned this plan automatically.') }}</flux:description>
                </flux:field>
            </div>
